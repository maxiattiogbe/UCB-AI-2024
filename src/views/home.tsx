        ...
        <div className="mx-auto max-w-2xl py-32 sm:py-48 lg:py-56">
          ...
          <div className="text-center">
            <h1 className="text-4xl font-bold tracking-tight text-white sm:text-6xl">
              Training for Life-Changing Skills
            </h1>
            <p className="mt-6 text-lg leading-8 text-gray-300">
              Hope Simulation provides a safe space to practice critical
              communication skills in mental health and other essential fields.
              Prepare for real-world interactions and make a difference.
            </p>
